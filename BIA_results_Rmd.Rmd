...
```{r global settings, echo=FALSE}
  ...
  p_case_detection <- c(0.25,0.40,0.55,0.70,0.85)
...
# Read in data ------------------------------------------------------------
  ...
  s10 <- readRDS("s10_4.Rda")
  s1a <- readRDS("s1a_4.Rda")
  s1b <- readRDS("s1b_4.Rda")
  s1c <- readRDS("s1c_4.Rda")
  s2a <- readRDS("s2a_4.Rda")
  s3a <- readRDS("s3a_4.Rda")
  s3b <- readRDS("s3b_4.Rda")
  s3c <- readRDS("s3c_4.Rda")
  s3d <- readRDS("s3d_4.Rda")
...
baseline_avg <- baseline_compar_raw %>% 
  ...
  kable(baseline_compar_raw)
  kable(baseline_compar_percent)
  kable(baseline_avg)
