...
```{r run simulations, echo=FALSE, message=FALSE}
  ...
  saveRDS(all_s, "results_base_fixsim.Rda")
...
# Read in data ------------------------------------------------------------
  ...
  alldat <- readRDS("results_base_fixsim.Rda")
...
p5 <- ggplot(bia_all_long %>% filter(cost_group=="bia_total" & scenario!="s10"),
  ...
  ylab("Total costs (million $)") + xlab("Year") +
  geom_point() +
  geom_line() +
  scale_y_continuous(breaks=seq(0,140,25),expand=c(0.02,0.02)) +
  theme_bw() +
...
p6 <- ggplot(bia_all_long %>% filter(cost_group=="bia_case_detection" & scenario!="s10"),
  ...
  ylab("Case detection costs (million $)") + xlab("Year") +
  geom_point() +
  geom_line() +
  theme_bw()
p7 <- ggplot(bia_all_long %>% filter(cost_group=="bia_treat" & scenario!="s10"),
  ...
  scale_x_continuous(expand=c(0.01,0.01)) +
  scale_y_continuous(expand=c(0.02,0.02)) +
  ylab("Treatment costs (million $)") + xlab("Year") +
  geom_point() +
  geom_line() +
  theme_bw()
p8 <- ggplot(bia_all_long %>% filter(cost_group=="bia_hosp" & scenario!="s10"),
  ...
  scale_x_continuous(expand=c(0.01,0.01)) +
  scale_y_continuous(expand=c(0.02,0.02)) +
  ylab("Hospitalisation costs (million $)") + xlab("Year") +
  geom_point() +
  geom_line() +
...
p9 <- ggplot(bia_all_long %>% filter(cost_group=="bia_other" & scenario!="s10"),
  ...
  scale_x_continuous(expand=c(0.01,0.01)) +
  scale_y_continuous(expand=c(0.02,0.02)) +
  ylab("Outpatient care costs (million $)") + xlab("Year") +
  geom_point() +
  geom_line() +
  #geom_hline(yintercept=0, linetype="dashed", color = "darkgrey") +
  theme_bw()
