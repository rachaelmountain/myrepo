...
```{r global settings, echo=FALSE}
  ...
  med_adherence <- 0.5 # the default, adjust for sensitivity analysis
...
```{r run simulations, echo=FALSE, message=FALSE}
  ...
  saveRDS(all_s, "results_MA03_5yrR_fixsim.Rda")
...
p <- ggarrange(p5,p6,p7,p8,ncol=2,nrow=2,common.legend=TRUE,legend="bottom")
bia_s10_s1a
bia_total
